...
export const EVAL_WORKBENCH_PANE_SCROLL =
  "min-h-0 min-w-0 flex-1 overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch] [scrollbar-gutter:stable]";
...
export const EVAL_PAGE_MAIN_CLASS =
  "vi-workbench-page mx-auto flex w-full min-w-0 max-w-6xl flex-1 min-h-0 flex-col overflow-hidden px-4 pt-[var(--eval-workbench-nav-gap)] sm:px-6";
